...
const challenges = [
  {
    title: "Classifying businesses into SIC/NAICS codes is manual and slow",
    icon: "document-search",
  },
  {
    title: "Research is error prone given subjectivity in names, websites, addresses, etc.",
    icon: "error",
  },
  {
    title: "Limited online presence & inconsistent data lead to misclassification",
    icon: "database-off",
  },
]
      ...
      <div className="container px-4 md:px-6">
        <div className="text-center space-y-4 mb-12">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">
            Key Challenges in Industry Classification
            <br />
            for Small Business Lending
          </h2>
          <p className="mx-auto max-w-3xl text-muted-foreground">
            For small business lenders, accurate industry classification is essential for risk assessment, compliance
            and portfolio management, but the process is often manual, time-consuming, prone to errors and inefficient
            at scale
          </p>
        </div>
