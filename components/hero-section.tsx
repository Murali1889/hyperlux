        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="space-y-6 z-10">
            ...
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">
              <span className="text-indigo-700">Automate</span> Industry Classification for Smarter Lending
            </h1>
            <p className="text-lg text-muted-foreground md:text-xl max-w-[600px]">
              Reduce risk, improve approval speed, and scale your small business lending with AI-powered industry
              classification that's 5x faster and 3x more accurate than manual processes.
            </p>
            ...
            <div className="flex items-center space-x-4 text-sm">
              ...
              <div className="text-muted-foreground">
                Trusted by <span className="font-medium text-foreground">500+</span> lending institutions
              </div>
            </div>
          </div>
